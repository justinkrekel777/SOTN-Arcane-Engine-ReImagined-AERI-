...
Compatibility:        
-Script written and tested using Bizhawk ver 2.11 and SOTN NymaFastCore, compatibility with other cores/versions not guaranteed  
-Tested in conjunction with Archipelago and is fully compatible (as far as I know)  
-Script is also fully compatible with the map location tracker in SOTN Rando Tools (again, as far as my testing goes)    
